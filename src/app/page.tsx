  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/20">
        ...
        {!searched && !loading && (
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-2">
            {[
              ...
              { title: 'Get Matched Jobs', desc: 'We search Adzuna, JSearch, Remotive simultaneously.' },
            ].map((step, i) => (
      ...
      <footer className="text-center py-6 text-xs text-slate-400 mt-8">
        Jobs sourced from Adzuna · JSearch (LinkedIn, Indeed, Glassdoor, ZipRecruiter) · Remotive
      </footer>
    </div>
  );
}
